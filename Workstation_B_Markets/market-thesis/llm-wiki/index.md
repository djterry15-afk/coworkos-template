...
Three operations (kept in the parent project's skills, not here): **Ingest** a new source → a page · **Query**
the wiki → an answer written back into a page · **Lint** for contradictions/staleness.
...
| Page | Covers |
|---|---|
| [financial-stress-indicators](pages/financial-stress-indicators.md) | which market metrics lead a stress event vs. which lag — the lead/lag structure behind the monitor's metric groups |

...
*monitors* the metrics; it does **not** make the thesis call (that stays in the parent market-thesis project `CONTEXT.md`).
...
5. **Glance.** Read the dashboard. That's the light review gate. If a reading is alarming, that is
   *input to your reasoning* — take it to the parent market-thesis project `CONTEXT.md`; the dashboard never concludes.
